...
struct Stadium_Seating {
	...
	double alpha;														 // bonus for adjacency of two parties in the same sub-group
	double beta;														 // bonus for connectedness of two parties in the same sub-group located in two different rows
